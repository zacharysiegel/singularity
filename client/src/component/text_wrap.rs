...
use crate::component::text_truncate::find_break_point_ltr;
...
fn wrap_long_token(
    ...
    while start < chars.len() {
        ...
        let break_point: usize = find_break_point_ltr(remaining, font, font_size, font_spacing, max_length).max(1);
